      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-white/70 max-w-2xl mx-auto">
            The tools and technologies I use to build amazing products
          </p>
        </motion.div>
        ...
        >
          <p className="text-white/80 text-lg leading-relaxed">
            This is a placeholder for the Skills page. Your existing Skills component will be integrated here.
          </p>
        </motion.div>
      </div>
    </div>
