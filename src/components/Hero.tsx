    ...
    >
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <motion.div
          ...
          className="absolute -top-20 -left-20 w-40 h-40 bg-gradient-to-br from-blue-400 to-purple-600 rounded-3xl transform rotate-12 opacity-20"
        ...
        <motion.div
          ...
          className="absolute -top-10 -right-10 w-32 h-32 bg-gradient-to-br from-orange-400 to-red-500 rounded-2xl transform -rotate-12 opacity-30"
        ...
        >
          ...
          >
            ...
            <span className="text-white/80 text-sm">Product Manager & Innovation Catalyst</span>
          </motion.div>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 border-2 border-white/30 rounded-full text-white font-semibold backdrop-blur-md hover:border-white/50 transition-colors"
            >
              Download Resume
            </motion.button>
          </motion.div>
