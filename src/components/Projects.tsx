...
const projects = [
  ...
  },
  {
    ...
    "roles": ['PM', 'FE Dev', 'BE Dev', 'QA', 'Designers',],
  ...
  },
  {
    ...
    "roles": ['PM', 'FE Engineers', 'Designers', 'Data Analysts','Marketing Ops', 'CRM'],
                  ...
                  return (
                    <div className="space-y-8">
                      ...
                      <div className="space-y-4">
                        <h4 className="text-xl font-semibold text-white">Teams</h4>
